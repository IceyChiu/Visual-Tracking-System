...
int main(){
    std::ifstream odomfile("/home/icey/share/2021.3.25_dataset/odometry.txt");
	if (!odomfile.is_open()){
    ...
    std::ifstream gtfile("/home/icey/share/2021.3.25_dataset/result_10.txt");
	if (!gtfile.is_open()){
    ...
    // 写入文件
    std::string result_dir = "/home/icey/share/2021.3.25_dataset/result_10_interpolation.txt";
